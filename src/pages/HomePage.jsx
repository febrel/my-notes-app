      ...
      <div className="container-description">
        <section className="project-card">
          <div className="project-header">
            <span className="project-badge">React App</span>
            <h3>QuickNotes</h3>
          </div>
          ...
          <div className="project-tech">
            ...
            <span className="tech-tag">CSS3 / Flexbox</span>
            <span className="tech-tag">LocalStorage</span>
          </div>

          <div className="project-links">
            <a href="https://github.com/febrel/my-notes-app" className="btn btn-secondary" target="_blank">Código en GitHub</a>
          </div>
        </section>
      </div>
    </>
